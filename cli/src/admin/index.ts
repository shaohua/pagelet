...
export function getAdminHelpText(): string {
  return [
    ...
    "  --allow <domains>                 Reviewer email domains, comma separated",
    "  --auth google|dev-preview         Auth mode (default: google)",
    "  --domain <url>                    Base URL when you map your own domain",
    "  --google-client-id <id>           OAuth client id, skips the prompt",
    "  --google-client-secret <secret>   OAuth client secret, skips the prompt",
